...
\author[ISTTOK training program, 29 July 2021] % (optional, use only with lots of authors)
%\author[B.~Carvalho, 29 July 2021] % (optional, use only with lots of authors)
...
\date[ISTTOK training program 2021] % (optional, should be abbreviation of conference name)
